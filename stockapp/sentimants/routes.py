...
sentimants = Blueprint('sentimants', __name__, static_folder='static', template_folder='templates')

@sentimants.route('/sdemo')
def sdemo():
    return render_template('sdemo.html')

@sentimants.route('/sentiment', methods = ['POST'])
def sentiment():
